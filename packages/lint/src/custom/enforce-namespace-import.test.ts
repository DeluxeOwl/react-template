...
ruleTester.run("enforce-namespace-import", enforceNamespaceImportRule, {
    invalid: [
        ...
        {
            code:   `import { contract } from "@react-template/core/todos"`,
            errors: [{ messageId: "mustBeNamespace" }],
            options,
        },
        // Default import — must use namespace
        {
            code:   `import todos from "@react-template/core/todos"`,
            errors: [{ messageId: "mustBeNamespace" }],
            options,
        },
        // Side-effect with type import — must use namespace
        {
            code:   `import type { Contract } from "@react-template/core/todos"`,
            errors: [{ messageId: "mustBeNamespace" }],
            options,
        },
        // Namespace import but wrong local name (completely different name)
        {
            code:   `import * as foo from "@react-template/core/todos"`,
        ...
        {
            code:   `import "@react-template/core/todos"`,
            errors: [{ messageId: "mustBeNamespace" }],
            options,
        },
    ...
    valid: [
        ...
        {
            code: `import * as todos from "@react-template/core/todos"`,
            options,
        },

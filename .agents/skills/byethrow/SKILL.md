...
For detailed API references and usage examples, refer to the documentation in the root `node_modules/@praha/byethrow-docs/docs/**/*.md`.
...
bunx @praha/byethrow-docs list

# List documentation with filter query
bunx @praha/byethrow-docs list --query "your query"
```
...
bunx @praha/byethrow-docs search "your query"

# Limit number of results (default: 5)
bunx @praha/byethrow-docs search "your query" --limit 10
```
...
bunx @praha/byethrow-docs toc path/to/document.md
```
